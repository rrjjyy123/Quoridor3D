...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function jo(e,t,n){return new zi({name:`SphericalGaussianBlur`,defines:{SAMPLES:go,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Mo(){return new zi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function No(){return new zi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Po(),fragmentShader:`
	...
	`}var Fo=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new bi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
}`,ul=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new wi(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new zi({vertexShader:cl,fragmentShader:ll,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Y(new ki(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},dl=class extends et{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,l=null,u=null,f=null,p=null,m=null,h=typeof XRWebGLBinding<`u`,_=new ul,v={},y=t.getContextAttributes(),b=null,S=null,C=[],w=[],T=new W,k=null,A=null,j=new wa;j.viewport=new Wt;let ee=new wa;ee.viewport=new Wt;let te=[j,ee],M=new Na,N=null,P=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new En,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new En,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new En,C[e]=t),t.getHandSpace()};function ne(e){let t=w.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function F(){r.removeEventListener(`select`,ne),r.removeEventListener(`selectstart`,ne),r.removeEventListener(`selectend`,ne),r.removeEventListener(`squeeze`,ne),r.removeEventListener(`squeezestart`,ne),r.removeEventListener(`squeezeend`,ne),r.removeEventListener(`end`,F),r.removeEventListener(`inputsourceschange`,re);for(let e=0;e<C.length;e++){let t=w[e];t!==null&&(w[e]=null,C[e].disconnect(t))}N=null,P=null,_.reset();for(let e in v)delete v[e];if(e.setRenderTarget(b),p=null,f=null,u=null,r=null,S=null,ue.stop(),n.isPresenting=!1,e.setPixelRatio(k),e.setSize(T.width,T.height,!1),A!==null){let e=A.camera;e.fov=A.fov,e.zoom=A.zoom,e.updateProjectionMatrix(),A=null}n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&V(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&V(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return u===null&&h&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return m},this.getSession=function(){return r},this.setSession=async function(l){if(r=l,r!==null){if(b=e.getRenderTarget(),r.addEventListener(`select`,ne),r.addEventListener(`selectstart`,ne),r.addEventListener(`selectend`,ne),r.addEventListener(`squeeze`,ne),r.addEventListener(`squeezestart`,ne),r.addEventListener(`squeezeend`,ne),r.addEventListener(`end`,F),r.addEventListener(`inputsourceschange`,re),y.xrCompatible!==!0&&await t.makeXRCompatible(),k=e.getPixelRatio(),e.getSize(T),h&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;y.depth&&(o=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=y.stencil?O:D,a=y.stencil?x:g);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};u=this.getBinding(),f=u.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new Kt(f.textureWidth,f.textureHeight,{format:E,type:d,depthTexture:new Si(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1,storeMultisampledDepthBuffer:f.ignoreDepthValues===!1,storeMultisampledStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new Kt(p.framebufferWidth,p.framebufferHeight,{format:E,type:d,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1,storeMultisampledDepthBuffer:p.ignoreDepthValues===!1,storeMultisampledStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),ue.setContext(r),ue.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function re(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=w.indexOf(n);r>=0&&(w[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=w.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=w.length){w.push(n),r=e;break}else if(w[e]===null){w[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let ie=new G,ae=new G;function oe(e,t,n){ie.setFromMatrixPosition(t.matrixWorld),ae.setFromMatrixPosition(n.matrixWorld);let r=ie.distanceTo(ae),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function se(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),M.near=ee.near=j.near=t,M.far=ee.far=j.far=n,(N!==M.near||P!==M.far)&&(r.updateRenderState({depthNear:M.near,depthFar:M.far}),N=M.near,P=M.far),M.layers.mask=e.layers.mask|6,j.layers.mask=M.layers.mask&-5,ee.layers.mask=M.layers.mask&-3;let i=e.parent,a=M.cameras;se(M,i);for(let e=0;e<a.length;e++)se(a[e],i);a.length===2?oe(M,j,ee):M.projectionMatrix.copy(j.projectionMatrix),A===null&&e.isPerspectiveCamera&&(A={camera:e,fov:e.fov,zoom:e.zoom}),I(e,M,i)};function I(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=it*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(f!==null||p!==null)return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(M)},this.getCameraTexture=function(e){return v[e]};let ce=null;function le(t,i){if(l=i.getViewerPose(c||a),m=i,l!==null){let t=l.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==M.cameras.length&&(M.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=u.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=te[n];o===void 0&&(o=new wa,o.layers.enable(n),o.viewport=new Wt,te[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(M.matrix.copy(o.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),i===!0&&M.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&h){u=n.getBinding();let e=u.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&h){e.state.unbindTexture(),u=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new wi,v[n]=e);let t=u.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=w[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}ce&&ce(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),m=null}let ue=new no;ue.setAnimationLoop(le),this.setAnimationLoop=function(e){ce=e},this.dispose=function(){}}},fl=new Yt,pl=new K;pl.set(-1,0,0,0,1,0,0,0,1);function ml(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Fi(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(fl.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(pl),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.retroreflectivity>0&&(e.retroreflectivity.value=t.retroreflectivity),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function hl(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return H(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return r[a]=typeof i==`number`||typeof i==`boolean`?i:ArrayBuffer.isView(i)?i.slice():i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?V(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):V(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var gl=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),_l=null;function vl(){return _l===null&&(_l=new $r(gl,16,16,j,v),_l.name=`DFG_LUT`,_l.minFilter=c,_l.magFilter=c,_l.wrapS=r,_l.wrapT=r,_l.generateMipmaps=!1,_l.needsUpdate=!0),_l}var yl=class{constructor(e={}){let{canvas:t=qe(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:c=!1,powerPreference:l=`default`,failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:p=!1,outputBufferType:h=d}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);_=n.getContextAttributes().alpha}else _=a;let S=h,C=new Set([te,ee,A]),w=new Set([d,g,m,x,y,b]),T=new Uint32Array(4),E=new Int32Array(4),D=new G,O=null,k=null,j=[],M=[],N=null;this.domElement=t,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let P=this,ne=!1,F=null,re=null,ie=null,ae=null;this._outputColorSpace=Le;let oe=0,se=0,I=null,ce=-1,le=null,ue=new Wt,de=new Wt,fe=null,pe=new J(0),me=0,he=t.width,ge=t.height,_e=1,ve=null,ye=null,be=new Wt(0,0,he,ge),xe=new Wt(0,0,he,ge),Se=!1,Ce=new fi,we=!1,Te=!1,Ee=new Yt,De=new G,Oe=new Wt,ke={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Ae=!1;function je(){return I===null?_e:1}let L=n;function Me(e,n){return t.getContext(e,n)}let Ne,Pe,R,Fe,z,B,Ie,Re,ze,Be,Ve,He,We,Ge,Ke,Je,Xe,Ze,$e,et,tt,nt,rt;try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:c,powerPreference:l,failIfMajorPerformanceCaveat:f};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r186`),t.addEventListener(`webglcontextlost`,U,!1),t.addEventListener(`webglcontextrestored`,ot,!1),t.addEventListener(`webglcontextcreationerror`,st,!1),L===null){let t=`webgl2`;if(L=Me(t,e),L===null)throw Me(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}it()}catch(e){throw t.removeEventListener(`webglcontextlost`,U,!1),t.removeEventListener(`webglcontextrestored`,ot,!1),t.removeEventListener(`webglcontextcreationerror`,st,!1),H(`WebGLRenderer: `+e.message),e}function it(){Ne=new Lo(L),Ne.init(),tt=new sl(L,Ne),Pe=new fo(L,Ne,e,tt),R=new al(L,Ne),Pe.reversedDepthBuffer&&p&&R.buffers.depth.setReversed(!0),re=L.createFramebuffer(),ie=L.createFramebuffer(),ae=L.createFramebuffer(),Fe=new Bo(L),z=new zc,B=new ol(L,Ne,R,z,Pe,tt,Fe),Ie=new Io(P),Re=new ro(L),nt=new lo(L,Re),ze=new Ro(L,Re,Fe,nt),Be=new Ho(L,ze,Re,nt,Fe),Ze=new Vo(L,Pe,B),Ke=new po(z),Ve=new Rc(P,Ie,Ne,Pe,nt,Ke),He=new ml(P,z),We=new Uc,Ge=new Xc(Ne),Xe=new co(P,Ie,R,Be,_,s),Je=new il(P,Be,Pe),rt=new hl(L,Fe,Pe,R),$e=new uo(L,Ne,Fe),et=new zo(L,Ne,Fe),Fe.programs=Ve.programs,P.capabilities=Pe,P.extensions=Ne,P.properties=z,P.renderLists=We,P.shadowMap=Je,P.state=R,P.info=Fe}S!==1009&&(N=new Wo(S,t.width,t.height,o,r,i));let at=new dl(P,L);this.xr=at,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){let e=Ne.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Ne.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return _e},this.setPixelRatio=function(e){e!==void 0&&(_e=e,this.setSize(he,ge,!1))},this.getSize=function(e){return e.set(he,ge)},this.setSize=function(e,n,r=!0){if(at.isPresenting){V(`WebGLRenderer: Can't change size while VR device is presenting.`);return}he=e,ge=n,t.width=Math.floor(e*_e),t.height=Math.floor(n*_e),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),N!==null&&N.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(he*_e,ge*_e).floor()},this.setDrawingBufferSize=function(e,n,r){he=e,ge=n,_e=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){H(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){V(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}N.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(ue)},this.getViewport=function(e){return e.copy(be)},this.setViewport=function(e,t,n,r){e.isVector4?be.set(e.x,e.y,e.z,e.w):be.set(e,t,n,r),R.viewport(ue.copy(be).multiplyScalar(_e).round())},this.getScissor=function(e){return e.copy(xe)},this.setScissor=function(e,t,n,r){e.isVector4?xe.set(e.x,e.y,e.z,e.w):xe.set(e,t,n,r),R.scissor(de.copy(xe).multiplyScalar(_e).round())},this.getScissorTest=function(){return Se},this.setScissorTest=function(e){R.setScissorTest(Se=e)},this.setOpaqueSort=function(e){ve=e},this.setTransparentSort=function(e){ye=e},this.getClearColor=function(e){return e.copy(Xe.getClearColor())},this.setClearColor=function(){Xe.setClearColor(...arguments)},this.getClearAlpha=function(){return Xe.getClearAlpha()},this.setClearAlpha=function(){Xe.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(I!==null){let t=I.texture.format;e=C.has(t)}if(e){let e=I.texture.type,t=w.has(e),n=Xe.getClearColor(),r=Xe.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,L.clearBufferuiv(L.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,L.clearBufferiv(L.COLOR,0,E))}else r|=L.COLOR_BUFFER_BIT}t&&(r|=L.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&L.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),F=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,U,!1),t.removeEventListener(`webglcontextrestored`,ot,!1),t.removeEventListener(`webglcontextcreationerror`,st,!1),Xe.dispose(),We.dispose(),Ge.dispose(),z.dispose(),Ie.dispose(),Be.dispose(),nt.dispose(),rt.dispose(),Ve.dispose(),at.dispose(),at.removeEventListener(`sessionstart`,mt),at.removeEventListener(`sessionend`,ht),gt.stop()};function U(e){e.preventDefault(),Ye(`WebGLRenderer: Context Lost.`),ne=!0}function ot(){Ye(`WebGLRenderer: Context Restored.`),ne=!1;let e=Fe.autoReset,t=Je.enabled,n=Je.autoUpdate,r=Je.needsUpdate,i=Je.type;it(),Fe.autoReset=e,Je.enabled=t,Je.autoUpdate=n,Je.needsUpdate=r,Je.type=i}function st(e){H(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function ct(e){let t=e.target;t.removeEventListener(`dispose`,ct),lt(t)}function lt(e){ut(e),z.remove(e)}function ut(e){let t=z.get(e).programs;t!==void 0&&(t.forEach(function(e){Ve.releaseProgram(e)}),e.isShaderMaterial&&Ve.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=ke);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=Et(e,t,n,r,i);R.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=ze.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;nt.setup(i,r,s,n,c);let h,g=$e;if(c!==null&&(h=Re.get(c),g=et,g.setIndex(h)),i.isMesh)r.wireframe===!0?(R.setLineWidth(r.wireframeLinewidth*je()),g.setMode(L.LINES)):g.setMode(L.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),R.setLineWidth(e*je()),i.isLineSegments?g.setMode(L.LINES):i.isLineLoop?g.setMode(L.LINE_LOOP):g.setMode(L.LINE_STRIP)}else i.isPoints?g.setMode(L.POINTS):i.isSprite&&g.setMode(L.TRIANGLES);if(i.isBatchedMesh){if(Ne.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Re.get(c).bytesPerElement:1,o=z.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(L,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function dt(e,t,n,r){F!==null&&e.isNodeMaterial&&F.setObject(r,e),we===!0&&Ke.setState(e,n,!1),e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,St(e,t,r),e.side=0,e.needsUpdate=!0,St(e,t,r),e.side=2):St(e,t,r)}this.compile=function(e,t,n=null){n===null&&(n=e),F!==null&&F.renderStart(e,t,n),k=Ge.get(n),k.init(t),M.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights(),F!==null&&F.updateLights(k.state.lightsArray),Te=this.localClippingEnabled,we=Ke.init(this.clippingPlanes,Te),we===!0&&Ke.setGlobalState(this.clippingPlanes,t),F!==null&&Je.render(k.state.shadowsArray,n,t);let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let i=e.material;if(i){if(Array.isArray(i))for(let a=0;a<i.length;a++){let o=i[a];dt(o,n,t,e),r.add(o)}else dt(i,n,t,e),r.add(i)}}),k=M.pop(),F!==null&&F.renderEnd(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){let t=z.get(e).currentProgram;(t===void 0||t.isReady())&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Ne.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let ft=null;function pt(e){ft&&ft(e)}function mt(){gt.stop()}function ht(){gt.start()}let gt=new no;gt.setAnimationLoop(pt),typeof self<`u`&&gt.setContext(self),this.setAnimationLoop=function(e){ft=e,at.setAnimationLoop(e),e===null?gt.stop():gt.start()},at.addEventListener(`sessionstart`,mt),at.addEventListener(`sessionend`,ht),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){H(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ne===!0)return;F!==null&&F.renderStart(e,t);let n=at.enabled===!0&&at.isPresenting===!0,r=N!==null&&(I===null||n)&&N.begin(P,I);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),at.enabled===!0&&at.isPresenting===!0&&(N===null||N.isCompositing()===!1)&&(at.cameraAutoUpdate===!0&&at.updateCamera(t),t=at.getCamera()),e.isScene===!0&&e.onBeforeRender(P,e,t,I),k=Ge.get(e,M.length),k.init(t),k.state.textureUnits=B.getTextureUnits(),M.push(k),Ee.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Ce.setFromProjectionMatrix(Ee,Ue,t.reversedDepth),Te=this.localClippingEnabled,we=Ke.init(this.clippingPlanes,Te),O=We.get(e,j.length),O.init(),j.push(O),at.enabled===!0&&at.isPresenting===!0){let e=P.xr.getDepthSensingMesh();e!==null&&_t(e,t,-1/0,P.sortObjects)}_t(e,t,0,P.sortObjects),O.finish(),F!==null&&F.updateLights(k.state.lightsArray),P.sortObjects===!0&&O.sort(ve,ye),Ae=at.enabled===!1||at.isPresenting===!1||at.hasDepthSensing()===!1,Ae&&Xe.addToRenderList(O,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),we===!0&&Ke.beginShadows();let i=k.state.shadowsArray;if(Je.render(i,e,t),we===!0&&Ke.endShadows(),(r&&N.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];yt(n,r,e,a)}Ae&&Xe.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];vt(O,e,n,n.viewport)}}else r.length>0&&yt(n,r,e,t),Ae&&Xe.render(e),vt(O,e,t)}I!==null&&se===0&&(B.updateMultisampleRenderTarget(I),B.updateRenderTargetMipmap(I)),r&&N.end(P),e.isScene===!0&&e.onAfterRender(P,e,t),nt.resetDefaultState(),ce=-1,le=null,M.pop(),M.length>0?(k=M[M.length-1],B.setTextureUnits(k.state.textureUnits),we===!0&&Ke.setGlobalState(P.clippingPlanes,k.state.camera)):k=null,j.pop(),O=j.length>0?j[j.length-1]:null,F!==null&&F.renderEnd()};function _t(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||e.intersectsFrustum(Ce)){r&&Oe.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Ee);let i=Be.update(e),a=e.material;a.visible&&O.push(e,i,a,n,Oe.z,null,t)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||e.intersectsFrustum(Ce))){let i=Be.update(e),a=e.material;if(r&&(e.boundingSphere===void 0?(i.boundingSphere===null&&i.computeBoundingSphere(),Oe.copy(i.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Oe.copy(e.boundingSphere.center)),Oe.applyMatrix4(e.matrixWorld).applyMatrix4(Ee)),Array.isArray(a)){let r=i.groups;for(let o=0,s=r.length;o<s;o++){let s=r[o],c=a[s.materialIndex];c&&c.visible&&O.push(e,i,c,n,Oe.z,s,t)}}else a.visible&&O.push(e,i,a,n,Oe.z,null,t)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)_t(i[e],t,n,r)}function vt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),we===!0&&Ke.setGlobalState(P.clippingPlanes,n),r&&R.viewport(ue.copy(r)),i.length>0&&bt(i,t,n),a.length>0&&bt(a,t,n),o.length>0&&bt(o,t,n),R.buffers.depth.setTest(!0),R.buffers.depth.setMask(!0),R.buffers.color.setMask(!0),R.setPolygonOffset(!1)}function yt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=Ne.has(`EXT_color_buffer_half_float`)||Ne.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new Kt(1,1,{generateMipmaps:!0,type:e?v:d,minFilter:u,samples:Math.max(4,Pe.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:q.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||ue;a.setSize(o.z*P.transmissionResolutionScale,o.w*P.transmissionResolutionScale);let s=P.getRenderTarget(),c=P.getActiveCubeFace(),l=P.getActiveMipmapLevel();P.setRenderTarget(a),P.getClearColor(pe),me=P.getClearAlpha(),me<1&&P.setClearColor(16777215,.5),P.clear(),Ae&&Xe.render(n);let f=P.toneMapping;P.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),we===!0&&Ke.setGlobalState(P.clippingPlanes,r),bt(e,n,r),B.updateMultisampleRenderTarget(a),B.updateRenderTargetMipmap(a),Ne.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,xt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(B.updateMultisampleRenderTarget(a),B.updateRenderTargetMipmap(a))}P.setRenderTarget(s,c,l),P.setClearColor(pe,me),p!==void 0&&(r.viewport=p),P.toneMapping=f}function bt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&xt(o,t,n,s,l,c)}}function xt(e,t,n,r,i,a){F!==null&&i.isNodeMaterial&&F.setObject(e,i),e.onBeforeRender(P,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(P,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,P.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,P.renderBufferDirect(n,t,r,i,e,a),i.side=2):P.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(P,t,n,r,i,a)}function St(e,t,n){t.isScene!==!0&&(t=ke);let r=z.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=Ve.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=Ve.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Ie.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,ct),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return wt(e,s),d}else s.uniforms=Ve.getUniforms(e),F!==null&&e.isNodeMaterial&&F.build(e,n,s),e.onBeforeCompile(s,P),d=Ve.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ke.uniform),wt(e,s),r.needsLights=Dt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.sunLights.value=i.state.sun,f.sunLightShadows.value=i.state.sunShadow,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.sunShadowMatrix.value=i.state.sunShadowMatrix,f.sunShadowCascade.value=i.state.sunShadowCascade,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Ct(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Zs.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function wt(e,t){let n=z.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Tt(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function Et(e,t,n,r,i){t.isScene!==!0&&(t=ke),B.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=I===null?P.outputColorSpace:I.isXRRenderTarget===!0?I.texture.colorSpace:q.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Ie.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(I===null||I.isXRRenderTarget===!0)&&(h=P.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=z.get(r),y=k.state.lights;if(we===!0&&(Te===!0||e!==le)){let t=e===le&&r.id===ce;Ke.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i._colorsTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i._colorsTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ke.numPlanes||v.numIntersection!==Ke.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=St(r,t,i),F&&r.isNodeMaterial&&F.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(R.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==ce&&(ce=r.id,C=!0),v.needsLights){let e=Tt(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||le!==e){R.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(L,`projectionMatrix`,e.projectionMatrix),T.setValue(L,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(L,De.setFromMatrixPosition(e.matrixWorld)),Pe.logarithmicDepthBuffer&&T.setValue(L,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(L,`isOrthographic`,e.isOrthographicCamera===!0),le!==e&&(le=e,C=!0,w=!0)}if(v.needsLights&&(y.state.sunShadowMap.length>0&&T.setValue(L,`sunShadowMap`,y.state.sunShadowMap,B),y.state.directionalShadowMap.length>0&&T.setValue(L,`directionalShadowMap`,y.state.directionalShadowMap,B),y.state.spotShadowMap.length>0&&T.setValue(L,`spotShadowMap`,y.state.spotShadowMap,B),y.state.pointShadowMap.length>0&&T.setValue(L,`pointShadowMap`,y.state.pointShadowMap,B)),i.isSkinnedMesh){T.setOptional(L,i,`bindMatrix`),T.setOptional(L,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(L,`boneTexture`,e.boneTexture,B))}i.isBatchedMesh&&(T.setOptional(L,i,`batchingTexture`),T.setValue(L,`batchingTexture`,i._matricesTexture,B),T.setOptional(L,i,`batchingIdTexture`),T.setValue(L,`batchingIdTexture`,i._indirectTexture,B),T.setOptional(L,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(L,`batchingColorTexture`,i._colorsTexture,B));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Ze.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(L,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=vl()),C){if(T.setValue(L,`toneMappingExposure`,P.toneMappingExposure),v.needsLights&&W(E,w),a&&r.fog===!0&&He.refreshFogUniforms(E,a),He.refreshMaterialUniforms(E,r,_e,ge,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}Zs.upload(L,Ct(v),E,B)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Zs.upload(L,Ct(v),E,B),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(L,`center`,i.center),T.setValue(L,`modelViewMatrix`,i.modelViewMatrix),T.setValue(L,`normalMatrix`,i.normalMatrix),T.setValue(L,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];rt.update(n,x),rt.bind(n,x)}}return x}function W(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.sunLights.needsUpdate=t,e.sunLightShadows.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Dt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return oe},this.getActiveMipmapLevel=function(){return se},this.getRenderTarget=function(){return I},this.setRenderTargetTextures=function(e,t,n){let r=z.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),z.get(e.texture).__webglTexture=t,z.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=z.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){I=e,oe=t,se=n;let r=null,i=!1,a=!1;if(e){let o=z.get(e);if(o.__useDefaultFramebuffer!==void 0){R.bindFramebuffer(L.FRAMEBUFFER,o.__webglFramebuffer),ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest,R.viewport(ue),R.scissor(de),R.setScissorTest(fe),ce=-1;return}if(o.__webglFramebuffer===void 0)B.setupRenderTarget(e);else if(o.__hasExternalTextures)B.rebindTextures(e,z.get(e.texture).__webglTexture,z.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&z.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);B.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=z.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&B.useMultisampledRTT(e)===!1?z.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest}else ue.copy(be).multiplyScalar(_e).floor(),de.copy(xe).multiplyScalar(_e).floor(),fe=Se;if(n!==0&&(r=re),R.bindFramebuffer(L.FRAMEBUFFER,r)&&R.drawBuffers(e,r),R.viewport(ue),R.scissor(de),R.setScissorTest(fe),i){let r=z.get(e.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=z.get(e.textures[t]);L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=z.get(e.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,t.__webglTexture,n)}ce=-1};function Ot(e){let t=z.get(e);return(t.__readFormat!==e.format||t.__readType!==e.type)&&(t.__readFormat=e.format,t.__readType=e.type,t.__formatReadable=Pe.textureFormatReadable(e.format),t.__typeReadable=Pe.textureTypeReadable(e.type)),t}this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=z.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){R.bindFramebuffer(L.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;e.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+s);let u=Ot(o);if(u.__formatReadable===!1){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(u.__typeReadable===!1){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&L.readPixels(t,n,r,i,tt.convert(c),tt.convert(l),a)}finally{let e=I===null?null:z.get(I).__webglFramebuffer;R.bindFramebuffer(L.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=z.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){R.bindFramebuffer(L.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;e.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+s);let d=Ot(o);if(d.__formatReadable===!1)throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(d.__typeReadable===!1)throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let f=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,f),L.bufferData(L.PIXEL_PACK_BUFFER,a.byteLength,L.STREAM_READ),L.readPixels(t,n,r,i,tt.convert(l),tt.convert(u),0),L.bindBuffer(L.PIXEL_PACK_BUFFER,null);let p=I===null?null:z.get(I).__webglFramebuffer;R.bindFramebuffer(L.FRAMEBUFFER,p);let m=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await Qe(L,m,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,f),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,a),L.bindBuffer(L.PIXEL_PACK_BUFFER,null),L.deleteBuffer(f),L.deleteSync(m),a}throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)}},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;B.setTexture2D(e,0),L.copyTexSubImage2D(L.TEXTURE_2D,n,0,0,o,s,i,a),R.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=tt.convert(t.format),_=tt.convert(t.type),v;t.isData3DTexture?(B.setTexture3D(t,0),v=L.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(B.setTexture2DArray(t,0),v=L.TEXTURE_2D_ARRAY):(B.setTexture2D(t,0),v=L.TEXTURE_2D),R.activeTexture(L.TEXTURE0),R.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,t.flipY),R.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),R.pixelStorei(L.UNPACK_ALIGNMENT,t.unpackAlignment);let y=R.getParameter(L.UNPACK_ROW_LENGTH),b=R.getParameter(L.UNPACK_IMAGE_HEIGHT),x=R.getParameter(L.UNPACK_SKIP_PIXELS),S=R.getParameter(L.UNPACK_SKIP_ROWS),C=R.getParameter(L.UNPACK_SKIP_IMAGES);R.pixelStorei(L.UNPACK_ROW_LENGTH,h.width),R.pixelStorei(L.UNPACK_IMAGE_HEIGHT,h.height),R.pixelStorei(L.UNPACK_SKIP_PIXELS,l),R.pixelStorei(L.UNPACK_SKIP_ROWS,u),R.pixelStorei(L.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=z.get(e),r=z.get(t),h=z.get(n.__renderTarget),g=z.get(r.__renderTarget);R.bindFramebuffer(L.READ_FRAMEBUFFER,h.__webglFramebuffer),R.bindFramebuffer(L.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,z.get(e).__webglTexture,i,d+n),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,z.get(t).__webglTexture,a,m+n)),L.blitFramebuffer(l,u,o,s,f,p,o,s,L.DEPTH_BUFFER_BIT,L.NEAREST);R.bindFramebuffer(L.READ_FRAMEBUFFER,null),R.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||z.has(e)){let n=z.get(e),r=z.get(t);R.bindFramebuffer(L.READ_FRAMEBUFFER,ie),R.bindFramebuffer(L.DRAW_FRAMEBUFFER,ae);for(let e=0;e<c;e++)w?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,n.__webglTexture,i),T?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,r.__webglTexture,a),i===0?T?L.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):L.copyTexSubImage2D(v,a,f,p,l,u,o,s):L.blitFramebuffer(l,u,o,s,f,p,o,s,L.COLOR_BUFFER_BIT,L.NEAREST);R.bindFramebuffer(L.READ_FRAMEBUFFER,null),R.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?L.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?L.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):L.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):L.texSubImage2D(L.TEXTURE_2D,a,f,p,o,s,g,_,h);R.pixelStorei(L.UNPACK_ROW_LENGTH,y),R.pixelStorei(L.UNPACK_IMAGE_HEIGHT,b),R.pixelStorei(L.UNPACK_SKIP_PIXELS,x),R.pixelStorei(L.UNPACK_SKIP_ROWS,S),R.pixelStorei(L.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&L.generateMipmap(v),R.unbindTexture()},this.initRenderTarget=function(e){z.get(e).__webglFramebuffer===void 0&&B.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?B.setTextureCube(e,0):e.isData3DTexture?B.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?B.setTexture2DArray(e,0):B.setTexture2D(e,0),R.unbindTexture()},this.resetState=function(){oe=0,se=0,I=null,R.reset(),nt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ue}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=q._getDrawingBufferColorSpace(e),t.unpackColorSpace=q._getUnpackColorSpace()}},bl={type:`change`},xl={type:`start`},Sl={type:`end`},Cl=new Rr,wl=new jr,Tl=Math.cos(70*Et.DEG2RAD),El=new G,Dl=2*Math.PI,Ol={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},kl=1e-6,Al=class extends $a{constructor(n,r=null){super(n,r),this.state=Ol.NONE,this.target=new G,this.cursor=new G,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.DOLLY,RIGHT:e.PAN},this.touches={ONE:t.ROTATE,TWO:t.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new G,this._lastQuaternion=new Dt,this._lastTargetPosition=new G,this._quat=new Dt().setFromUnitVectors(n.up,new G(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Qa,this._sphericalDelta=new Qa,this._scale=1,this._panOffset=new G,this._rotateStart=new W,this._rotateEnd=new W,this._rotateDelta=new W,this._panStart=new W,this._panEnd=new W,this._panDelta=new W,this._dollyStart=new W,this._dollyEnd=new W,this._dollyDelta=new W,this._dollyDirection=new G,this._mouse=new W,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Ml.bind(this),this._onPointerDown=jl.bind(this),this._onPointerUp=Nl.bind(this),this._onContextMenu=Bl.bind(this),this._onMouseWheel=Il.bind(this),this._onKeyDown=Ll.bind(this),this._onTouchStart=Rl.bind(this),this._onTouchMove=zl.bind(this),this._onMouseDown=Pl.bind(this),this._onMouseMove=Fl.bind(this),this._interceptControlDown=Vl.bind(this),this._interceptControlUp=Hl.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.state=Ol.NONE,this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents();let e=this.domElement.getRootNode();e.removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),e.removeEventListener(`keyup`,this._interceptControlUp,{capture:!0}),this._controlActive=!1,this._pointers.length=0,this._pointerPositions={},this.domElement.style.touchAction=``,this.domElement.style.cursor=`auto`}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(bl),this.update(),this.state=Ol.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;El.copy(t).sub(this.target),El.applyQuaternion(this._quat),this._spherical.setFromVector3(El),this.autoRotate&&this.state===Ol.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=Dl:n>Math.PI&&(n-=Dl),r<-Math.PI?r+=Dl:r>Math.PI&&(r-=Dl),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(El.setFromSpherical(this._spherical),El.applyQuaternion(this._quatInverse),t.copy(this.target).add(El),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=El.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new G(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new G(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=El.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(Cl.origin.copy(this.object.position),Cl.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Cl.direction))<Tl?this.object.lookAt(this.target):(wl.setFromNormalAndCoplanarPoint(this.object.up,this.target),Cl.intersectPlane(wl,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>kl||8*(1-this._lastQuaternion.dot(this.object.quaternion))>kl||this._lastTargetPosition.distanceToSquared(this.target)>kl?(this.dispatchEvent(bl),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?Dl/60/60*this.autoRotateSpeed:Dl/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){El.setFromMatrixColumn(t,0),El.multiplyScalar(-e),this._panOffset.add(El)}_panUp(e,t){this.screenSpacePanning===!0?El.setFromMatrixColumn(t,1):(El.setFromMatrixColumn(t,0),El.crossVectors(this.object.up,El)),El.multiplyScalar(e),this._panOffset.add(El)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;El.copy(r).sub(this.target);let i=El.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(Dl*this._rotateDelta.x/t.clientHeight),this._rotateUp(Dl*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(Dl*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-Dl*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(Dl*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-Dl*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(Dl*this._rotateDelta.x/t.clientHeight),this._rotateUp(Dl*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new W,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function jl(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function Ml(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function Nl(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(Sl),this.state=Ol.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y})}}function Pl(t){let n;switch(t.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=Ol.DOLLY;break;case e.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=Ol.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=Ol.ROTATE}break;case e.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=Ol.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=Ol.PAN}break;default:this.state=Ol.NONE}this.state!==Ol.NONE&&this.dispatchEvent(xl)}function Fl(e){switch(this.state){case Ol.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case Ol.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case Ol.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e)}}function Il(e){this.enabled!==!1&&this.enableZoom!==!1&&this.state===Ol.NONE&&(e.preventDefault(),this.dispatchEvent(xl),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(Sl))}function Ll(e){this.enabled!==!1&&this._handleKeyDown(e)}function Rl(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case t.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=Ol.TOUCH_ROTATE;break;case t.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=Ol.TOUCH_PAN;break;default:this.state=Ol.NONE}break;case 2:switch(this.touches.TWO){case t.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=Ol.TOUCH_DOLLY_PAN;break;case t.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=Ol.TOUCH_DOLLY_ROTATE;break;default:this.state=Ol.NONE}break;default:this.state=Ol.NONE}this.state!==Ol.NONE&&this.dispatchEvent(xl)}function zl(e){switch(this._trackPointer(e),this.state){case Ol.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case Ol.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case Ol.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case Ol.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=Ol.NONE}}function Bl(e){this.enabled!==!1&&e.preventDefault()}function Vl(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function Hl(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}var Ul=class extends Nn{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new Ti;e.deleteAttribute(`uv`);let t=new Vi({side:1}),n=new Vi,r=new Ea(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new Y(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new ci(e,n,6),o=new Cn;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new Y(e,Wl(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new Y(e,Wl(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new Y(e,Wl(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new Y(e,Wl(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new Y(e,Wl(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new Y(e,Wl(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function Wl(e){return new Ui({color:0,emissive:16777215,emissiveIntensity:e})}var Gl={linear:e=>e,inOut:e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2,out:e=>1-(1-e)**3,in:e=>e*e*e,outBack:e=>1+2.70158*(e-1)**3+1.70158*(e-1)**2,outBounce:e=>{let t=7.5625,n=2.75;return e<1/n?t*e*e:e<2/n?t*(e-=1.5/n)*e+.75:e<2.5/n?t*(e-=2.25/n)*e+.9375:t*(e-=2.625/n)*e+.984375}},Kl=new Set;function ql({duration:e=.4,delay:t=0,easing:n=Gl.inOut,update:r,complete:i}){return new Promise(a=>{Kl.add({t:-t,duration:e,easing:n,update:r,complete:i,resolve:a})})}function Jl(e){for(let t of Kl){if(t.t+=e,t.t<0)continue;let n=Math.min(1,t.t/t.duration);t.update?.(t.easing(n),n),n>=1&&(Kl.delete(t),t.complete?.(),t.resolve())}}function Yl(e){let t=new yl({antialias:!0,powerPreference:`high-performance`});t.setSize(e.clientWidth,e.clientHeight),t.outputColorSpace=Le,t.toneMapping=4,t.toneMappingExposure=1.05,t.shadowMap.enabled=!0,t.shadowMap.type=1,e.appendChild(t.domElement);let n=new Nn;n.background=new J(1313800),n.fog=new Mn(1313800,.018),n.environment=new Eo(t).fromScene(new Ul,.04).texture,n.environmentIntensity=.45;let r=new wa(38,e.clientWidth/e.clientHeight||1,.5,200);r.position.set(0,18,16);let i=new Al(r,t.domElement);i.enableDamping=!0,i.dampingFactor=.08,i.enablePan=!1,i.minDistance=9,i.maxDistance=48,i.maxPolarAngle=1.32,i.target.set(0,.4,0);let a=new fa(16769728,2759184,.55);n.add(a);let o=new ka(16767144,2.6);o.position.set(9,20,11),o.castShadow=!0,o.shadow.camera.left=o.shadow.camera.bottom=-13,o.shadow.camera.right=o.shadow.camera.top=13,o.shadow.camera.near=5,o.shadow.camera.far=50,o.shadow.bias=-4e-4,o.shadow.normalBias=.02,o.shadow.radius=4,n.add(o);let s=new ka(10467583,.55);s.position.set(-14,8,-12),n.add(s);let c=new Ea(16754784,30,40,1.6);c.position.set(0,9,0),n.add(c);let l={high:!0};function u(e){l.high=e,t.setPixelRatio(e?Math.min(window.devicePixelRatio,2):1),o.shadow.mapSize.set(e?2048:1024,e?2048:1024),o.shadow.radius=e?4:1,o.shadow.map&&(o.shadow.map.dispose(),o.shadow.map=null),t.shadowMap.needsUpdate=!0}u(!0);let d=new Set,f=new Set;function p(){let n=e.clientWidth,i=e.clientHeight;if(n&&i){t.setSize(n,i),r.aspect=n/i,r.updateProjectionMatrix();for(let e of f)e(n,i)}}window.addEventListener(`resize`,p),new ResizeObserver(p).observe(e);let m=new Pa,h=()=>{m.update();let e=Math.min(m.getDelta(),.05),a=m.getElapsed();Jl(e);for(let t of d)t(e,a);i.update(),t.render(n,r)};return t.setAnimationLoop(h),{loop:h,renderer:t,scene:n,camera:r,controls:i,lights:{key:o,hemi:a,rim:s,warmSpot:c},onFrame:d,resizeHandlers:f,setQuality:u,quality:l}}var Xl=new G;function Zl(e,t,n,r,i,a){let o=2*Math.PI*i/4,s=Math.max(a-2*i,0),c=Math.PI/4;Xl.copy(t),Xl[r]=0,Xl.normalize();let l=.5*o/(o+s),u=1-Xl.angleTo(e)/c;return Math.sign(Xl[n])===1?u*l:s/(o+s)+l+l*(1-u)}var Ql=class e extends Ti{constructor(e=1,t=1,n=1,r=2,i=.1){let a=r*2+1;if(i=Math.min(e/2,t/2,n/2,i),super(1,1,1,a,a,a),this.type=`RoundedBoxGeometry`,this.parameters={width:e,height:t,depth:n,segments:r,radius:i},a===1)return;let o=this.toNonIndexed();this.index=null,this.attributes.position=o.attributes.position,this.attributes.normal=o.attributes.normal,this.attributes.uv=o.attributes.uv;let s=new G,c=new G,l=new G(e,t,n).divideScalar(2).subScalar(i),u=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,p=u.length/6,m=new G,h=.5/a;for(let r=0,a=0;r<u.length;r+=3,a+=2)switch(s.fromArray(u,r),c.copy(s),c.x-=Math.sign(c.x)*h,c.y-=Math.sign(c.y)*h,c.z-=Math.sign(c.z)*h,c.normalize(),u[r+0]=l.x*Math.sign(s.x)+c.x*i,u[r+1]=l.y*Math.sign(s.y)+c.y*i,u[r+2]=l.z*Math.sign(s.z)+c.z*i,d[r+0]=c.x,d[r+1]=c.y,d[r+2]=c.z,Math.floor(r/p)){case 0:m.set(1,0,0),f[a+0]=Zl(m,c,`z`,`y`,i,n),f[a+1]=1-Zl(m,c,`y`,`z`,i,t);break;case 1:m.set(-1,0,0),f[a+0]=1-Zl(m,c,`z`,`y`,i,n),f[a+1]=1-Zl(m,c,`y`,`z`,i,t);break;case 2:m.set(0,1,0),f[a+0]=1-Zl(m,c,`x`,`z`,i,e),f[a+1]=Zl(m,c,`z`,`x`,i,n);break;case 3:m.set(0,-1,0),f[a+0]=1-Zl(m,c,`x`,`z`,i,e),f[a+1]=1-Zl(m,c,`z`,`x`,i,n);break;case 4:m.set(0,0,1),f[a+0]=1-Zl(m,c,`x`,`y`,i,e),f[a+1]=1-Zl(m,c,`y`,`x`,i,t);break;case 5:m.set(0,0,-1),f[a+0]=Zl(m,c,`x`,`y`,i,e),f[a+1]=1-Zl(m,c,`y`,`x`,i,t)}}static fromJSON(t){return new e(t.width,t.height,t.depth,t.segments,t.radius)}};function $l(e){let t=new Uint8Array(512),n=new Uint8Array(256).map((e,t)=>t),r=e*9301+49297,i=()=>(r=(r*9301+49297)%233280)/233280;for(let e=255;e>0;e--){let t=Math.floor(i()*(e+1));[n[e],n[t]]=[n[t],n[e]]}for(let e=0;e<512;e++)t[e]=n[e&255];let a=new Float32Array(256).map(()=>i()),o=e=>e*e*(3-2*e),s=(e,t,n)=>e+(t-e)*n;return(e,n,r=256,i=256)=>{let c=Math.floor(e),l=Math.floor(n),u=o(e-c),d=o(n-l),f=(e,n)=>a[t[((e%r+r)%r&255)+t[(n%i+i)%i&255]]];return s(s(f(c,l),f(c+1,l),u),s(f(c,l+1),f(c+1,l+1),u),d)}}function eu({light:e,dark:t,rings:r=10,seed:i=1,size:a=512,streak:o=.35,knots:s=0}){let c=$l(i),l=document.createElement(`canvas`);l.width=l.height=a;let u=document.createElement(`canvas`);u.width=u.height=a;let d=l.getContext(`2d`),f=u.getContext(`2d`),p=d.createImageData(a,a),m=f.createImageData(a,a),h=[],g=$l(i+7);for(let e=0;e<s;e++)h.push([g(e*3.1,.5)*a,g(.5,e*5.7)*a,10+g(e,e)*18]);for(let n=0;n<a;n++){let i=n/a;for(let s=0;s<a;s++){let l=s/a,u=c(l*4,i*6,4,6)*.9+c(l*8,i*12,8,12)*.4+c(l*16,i*24,16,24)*.15;for(let[e,t,r]of h){let i=s-e,a=(n-t)*2.2,o=i*i+a*a;u+=r*r*1.5/(o+r*r)*.8}let d=i*r+u*2.2,f=d-Math.floor(d),g=Math.abs(Math.sin(f*Math.PI))**6,_=c(l*3,i*180,3,180),v=Math.min(1,g*.55+_*o+c(l*40,i*40,40,40)*.08),y=(s+n*a)*4;p.data[y]=e[0]+(t[0]-e[0])*v,p.data[y+1]=e[1]+(t[1]-e[1])*v,p.data[y+2]=e[2]+(t[2]-e[2])*v,p.data[y+3]=255;let b=255-v*110;m.data[y]=m.data[y+1]=m.data[y+2]=b,m.data[y+3]=255}}d.putImageData(p,0,0),f.putImageData(m,0,0);let _=new xi(l);_.colorSpace=Le,_.wrapS=_.wrapT=n,_.anisotropy=8;let v=new xi(u);return v.wrapS=v.wrapT=n,{map:_,bumpMap:v}}function tu(e,{offset:t=[0,0],repeat:n=[1,1],rotation:r=0}={}){let i=e.clone();return i.offset.set(t[0],t[1]),i.repeat.set(n[0],n[1]),i.rotation=r,i.needsUpdate=!0,i}var nu={walnut:{light:[112,70,42],dark:[58,33,18],rings:14,streak:.4},maple:{light:[226,188,138],dark:[176,128,80],rings:9,streak:.3},cherry:{light:[190,104,62],dark:[118,52,26],rings:11,streak:.35},table:{light:[74,44,28],dark:[34,19,11],rings:22,streak:.45}},ru=.24,iu=1.24,au=.5,ou=2.24,su=ru*.78,cu=.62,lu=10.92,uu=17.72,du=(e,t)=>({x:(e-4)*iu,z:(4-t)*iu}),fu=e=>({x:(e.x-3.5)*iu,z:(3.5-e.y)*iu,rotY:e.o===`h`?0:Math.PI/2}),pu=[0,-Math.PI/2,Math.PI,Math.PI/2];function mu(e,t){let n=Math.round(e/iu+4),r=Math.round(4-t/iu);return{x:n,y:r,inside:n>=0&&n<9&&r>=0&&r<9}}function hu(e,t){let n=e/iu+3.5,r=3.5-t/iu,i=Math.max(0,Math.min(7,Math.round(n))),a=Math.max(0,Math.min(7,Math.round(r))),o=5.7;return{x:i,y:a,inside:Math.abs(e)<o&&Math.abs(t)<o}}var gu=au-.15;function _u(){return{walnut:eu({...nu.walnut,seed:3,size:1024,knots:2}),maple:eu({...nu.maple,seed:11,size:512}),cherry:eu({...nu.cherry,seed:21,size:512}),table:eu({...nu.table,seed:5,size:1024,knots:3})}}function vu(e){let t=document.createElement(`canvas`);t.width=t.height=128;let n=t.getContext(`2d`);n.font=`600 84px Georgia, "Times New Roman", serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillStyle=`#e8c27a`,n.shadowColor=`rgba(0,0,0,0.6)`,n.shadowBlur=6,n.fillText(e,64,70);let r=new xi(t);return r.colorSpace=Le,r}function yu(e){let t=new wn,n=new Vi({map:tu(e.table.map,{repeat:[3,3]}),bumpMap:tu(e.table.bumpMap,{repeat:[3,3]}),bumpScale:.6,roughness:.62,color:12098184}),r=new Y(new Ei(60,64),n);r.rotation.x=-Math.PI/2,r.receiveShadow=!0,t.add(r);let i=new Hi({map:e.walnut.map,bumpMap:e.walnut.bumpMap,bumpScale:.5,roughness:.42,clearcoat:.6,clearcoatRoughness:.25}),a=new Y(new Ql(uu,gu,uu,6,.35),i);a.position.y=gu/2,a.castShadow=!0,a.receiveShadow=!0,t.add(a);let o=new Vi({color:2758412,roughness:.9}),s=new Y(new Ti(lu+.1,.02,lu+.1),o);s.position.y=gu+.005,s.receiveShadow=!0,t.add(s);let c=new Vi({color:13210943,metalness:1,roughness:.28}),l=.08,u=lu/2+.16;for(let e=0;e<4;e++){let n=new Y(new Ti(u*2+l,.05,l),c),r=e*Math.PI/2;n.position.set(Math.sin(r)*u,gu+.02,Math.cos(r)*u),n.rotation.y=r,n.castShadow=!0,t.add(n)}let d=new Ql(1,.2,1,3,.06),f=[];for(let n=0;n<9;n++)for(let r=0;r<9;r++){let i=(r*7+n*3)%2?0:Math.PI/2,a=[(r*37+n*11)%17/17,(r*13+n*29)%19/19],o=new Y(d,new Hi({map:tu(e.maple.map,{offset:a,repeat:[.35,.35],rotation:i}),bumpMap:tu(e.maple.bumpMap,{offset:a,repeat:[.35,.35],rotation:i}),bumpScale:.35,roughness:.48,clearcoat:.35,clearcoatRoughness:.35,emissive:new J(0)})),s=du(r,n);o.position.set(s.x,au-.1,s.z),o.castShadow=!0,o.receiveShadow=!0,o.userData.cell={x:r,y:n},t.add(o),f.push(o)}let p=new ki(.6,.6),m=lu/2+.62;for(let e=0;e<9;e++){let n=new Y(p,new zr({map:vu(`abcdefghi`[e]),transparent:!0,depthWrite:!1}));n.rotation.x=-Math.PI/2,n.position.set((e-4)*iu,gu+.012,m),t.add(n);let r=new Y(p,new zr({map:vu(String(e+1)),transparent:!0,depthWrite:!1}));r.rotation.x=-Math.PI/2,r.position.set(-m,gu+.012,(4-e)*iu),t.add(r)}let h=new Vi({color:3810068,roughness:.7,transparent:!0,opacity:.55}),g=new Ql(5.1,.02,ou+.24,2,.01),_=lu/2+1.9;for(let e=0;e<4;e++){let n=e*Math.PI/2,r=new Y(g,h);r.position.set(Math.sin(n)*_,gu+.01,Math.cos(n)*_),r.rotation.y=n,r.receiveShadow=!0,t.add(r)}return{group:t,cells:f,frameMat:i}}var bu=[{id:`ivory`,name:`상아`,hex:`#f6efe0`,lacquer:!1},{id:`ebony`,name:`흑단`,hex:`#2b2320`,lacquer:!1},{id:`crimson`,name:`버건디`,hex:`#9a1f2e`,lacquer:!0},{id:`teal`,name:`청록`,hex:`#1d7a73`,lacquer:!0},{id:`gold`,name:`황금`,hex:`#d19a2a`,lacquer:!0,metal:!0},{id:`navy`,name:`남색`,hex:`#26407e`,lacquer:!0}],xu=e=>bu.find(t=>t.id===e)??bu[0],Su=null;function Cu(){if(Su)return Su;let e=new Oi([[0,0],[.36,0],[.38,.03],[.38,.08],[.33,.12],[.3,.16],[.24,.22],[.19,.34],[.15,.48],[.14,.56],[.23,.6],[.24,.63],[.16,.67],[.13,.7]].map(([e,t])=>new W(e,t)),48),t=new Ai(.21,40,24);return t.translate(0,.86,0),Su={body:e,head:t},Su}function wu(e,t){let n=xu(e),{body:r,head:i}=Cu(),a=new Hi({color:new J(n.hex),roughness:n.metal?.3:n.lacquer?.28:.42,metalness:n.metal?.85:0,clearcoat:1,clearcoatRoughness:n.lacquer?.06:.2,sheen:n.lacquer?0:.3,emissive:new J(n.hex),emissiveIntensity:0});n.lacquer||(a.map=tu(t.maple.map,{repeat:[.6,1.4]}),a.bumpMap=t.maple.bumpMap,a.bumpScale=.2);let o=new wn;for(let e of[r,i]){let t=new Y(e,a);t.castShadow=!0,t.receiveShadow=!0,t.scale.setScalar(1.3),o.add(t)}return o.userData.material=a,o}var Tu=null;function Eu(){return Tu||(Tu=new Ql(ou,cu,su,3,.035),Tu.translate(0,cu/2,0)),Tu}var Du=null;function Ou(e){Du||=new Hi({map:tu(e.cherry.map,{repeat:[.9,.25]}),bumpMap:tu(e.cherry.bumpMap,{repeat:[.9,.25]}),bumpScale:.4,roughness:.4,clearcoat:.7,clearcoatRoughness:.2});let t=new Y(Eu(),Du);return t.castShadow=!0,t.receiveShadow=!0,t}function ku(){let e=new Vi({color:4063098,emissive:1769306,emissiveIntensity:1.4,transparent:!0,opacity:.8,depthWrite:!1}),t=new Y(Eu(),e);return t.renderOrder=5,t.visible=!1,t}function Au(e=`rgba(255,255,255,1)`,t=`rgba(255,255,255,0)`,n=!1){let r=document.createElement(`canvas`);r.width=r.height=128;let i=r.getContext(`2d`),a=i.createRadialGradient(64,64,n?30:0,64,64,62);return n?(a.addColorStop(0,`rgba(255,255,255,0)`),a.addColorStop(.35,e),a.addColorStop(.55,`rgba(255,255,255,0.35)`),a.addColorStop(1,t)):(a.addColorStop(0,e),a.addColorStop(1,t)),i.fillStyle=a,i.fillRect(0,0,128,128),new xi(r)}var ju=class{constructor(e){this.stage=e,this.scene=e.scene,this.glowTex=Au(),this.ringTex=Au(`rgba(255,255,255,1)`,`rgba(255,255,255,0)`,!0),this.markers=[],this.markerGeo=new ki(.95,.95),this.hovered=null,this.turnRing=new Y(new ki(1.5,1.5),new zr({map:this.ringTex,transparent:!0,depthWrite:!1,blending:2,color:16765562})),this.turnRing.rotation.x=-Math.PI/2,this.turnRing.renderOrder=3,this.scene.add(this.turnRing),this.particles=[],e.onFrame.add((e,t)=>this.update(e,t))}setTurnRing(e,t){this.turnRingTarget=e,this.turnRing.material.color.set(t).lerp(new J(16769696),.35),this.turnRing.visible=!!e}showMarkers(e,t){this.clearMarkers();let n=new J(t).lerp(new J(16773312),.4);for(let t of e){let e=new zr({map:this.glowTex,color:n,transparent:!0,opacity:0,depthWrite:!1,blending:2}),r=new Y(this.markerGeo,e),i=du(t.x,t.y);r.position.set(i.x,au+.012,i.z),r.rotation.x=-Math.PI/2,r.renderOrder=4,r.userData.move=t,r.userData.born=performance.now(),this.scene.add(r),this.markers.push(r)}}setHoverCell(e){this.hovered=e}clearMarkers(){for(let e of this.markers)this.scene.remove(e),e.material.dispose();this.markers=[]}burst(e,{color:t=15323816,count:n=26,speed:r=2.2,size:i=.22,life:a=.9,up:o=1.2}={}){let s=new Dr,c=new Float32Array(n*3),l=[];for(let t=0;t<n;t++){c[t*3]=e.x,c[t*3+1]=e.y,c[t*3+2]=e.z;let n=Math.random()*Math.PI*2,i=r*(.4+Math.random()*.6);l.push(new G(Math.cos(n)*i,Math.random()*o,Math.sin(n)*i))}s.setAttribute(`position`,new fr(c,3));let u=new vi(s,new pi({map:this.glowTex,color:t,size:i,transparent:!0,depthWrite:!1,blending:2}));this.scene.add(u),this.particles.push({kind:`points`,obj:u,vel:l,age:0,life:a,drag:3.5,gravity:-1.5})}confetti(e){let t=new ci(new ki(.16,.26),new Vi({side:2,roughness:.4,metalness:.3}),420),n=[],r=new J;for(let i=0;i<420;i++){let a=Math.random()*Math.PI*2,o=Math.random()*3;n.push({p:new G(Math.cos(a)*o,1+Math.random()*2,Math.sin(a)*o),v:new G(Math.cos(a)*(2+Math.random()*5),8+Math.random()*9,Math.sin(a)*(2+Math.random()*5)),rot:new on(Math.random()*6,Math.random()*6,Math.random()*6),spin:new G(Math.random()*8-4,Math.random()*8-4,Math.random()*8-4)}),t.setColorAt(i,r.set(e[i%e.length]))}t.instanceColor.needsUpdate=!0,this.scene.add(t),this.particles.push({kind:`confetti`,obj:t,data:n,age:0,life:7})}clearAll(){for(let e of this.particles)this.scene.remove(e.obj),e.obj.geometry.dispose(),e.obj.material.dispose();this.particles=[],this.clearMarkers()}update(e,t){for(let e of this.markers){let n=Math.min(1,(performance.now()-e.userData.born)/250),r=e.userData.move,i=this.hovered&&this.hovered.x===r.x&&this.hovered.y===r.y;e.material.opacity=n*(i?1:.5+Math.sin(t*4)*.15);let a=i?1.08:.9+Math.sin(t*4)*.03;e.scale.set(a,a,a)}if(this.turnRing.visible&&this.turnRingTarget){let e=this.turnRingTarget.position;this.turnRing.position.set(e.x,Math.max(au+.015,e.y+.015),e.z);let n=1+Math.sin(t*3)*.08;this.turnRing.scale.set(n,n,n),this.turnRing.material.opacity=.75+Math.sin(t*3)*.2}let n=new Yt,r=new Dt,i=new G(1,1,1);for(let t=this.particles.length-1;t>=0;t--){let a=this.particles[t];if(a.age+=e,a.kind===`points`){let t=a.obj.geometry.attributes.position.array;a.vel.forEach((n,r)=>{n.multiplyScalar(Math.exp(-a.drag*e)),n.y+=a.gravity*e,t[r*3]+=n.x*e,t[r*3+1]=Math.max(au,t[r*3+1]+n.y*e),t[r*3+2]+=n.z*e}),a.obj.geometry.attributes.position.needsUpdate=!0,a.obj.material.opacity=1-a.age/a.life}else a.data.forEach((t,o)=>{t.v.y-=9*e,t.v.multiplyScalar(Math.exp(-1.6*e)),t.v.y<-2.2&&(t.v.y=-2.2),t.p.addScaledVector(t.v,e),t.p.y<.52?(t.p.y=.52,t.v.set(0,0,0)):(t.rot.x+=t.spin.x*e,t.rot.y+=t.spin.y*e,t.rot.z+=t.spin.z*e),r.setFromEuler(t.rot);let s=Math.min(1,(a.life-a.age)/1.2);n.compose(t.p,r,i.clone().multiplyScalar(Math.max(.001,s))),a.obj.setMatrixAt(o,n)}),a.obj.instanceMatrix.needsUpdate=!0;a.age>=a.life&&(this.scene.remove(a.obj),a.obj.geometry.dispose(),a.obj.material.dispose(),this.particles.splice(t,1))}}},Mu=lu/2+1.9,Nu=.48,Pu=new zr({transparent:!0,opacity:0,depthWrite:!1,colorWrite:!1}),Fu=(e,t)=>{let n=(t-e)%(Math.PI*2);return n>Math.PI&&(n-=Math.PI*2),n<-Math.PI&&(n+=Math.PI*2),e+n},Iu=class{constructor(e){this.container=e,this.stage=Yl(e),this.woods=_u(),this.board=yu(this.woods),this.stage.scene.add(this.board.group),this.effects=new ju(this.stage),this.ghost=ku(),this.stage.scene.add(this.ghost),this.pawns=[],this.storage=[],this.placed=[],this.goalStrips=[],this.cameraMode=`auto`,this.attract=!0,this.handlers={},this.hitTargets=[],this.trayHits=[],this.selected=null,this.trayGlow=new Cn;let t=new Y(new ki(5.8,3.2),new zr({map:this.effects.glowTex,transparent:!0,opacity:0,depthWrite:!1,blending:2,color:16762992}));t.rotation.x=-Math.PI/2,t.position.y=gu+.03,t.renderOrder=3,this.trayGlow.add(t),this.trayGlow.visible=!1,this.stage.scene.add(this.trayGlow),this.trayGlowMat=t.material,this.raycaster=new Ya,this.plane=new jr(new G(0,1,0),-au),this.bindPointer(),this.stage.onFrame.add((e,t)=>{if(this.trayGlow.visible){let e=this.selected?.kind===`walls`;this.trayGlowMat.opacity=e?.85+Math.sin(t*5)*.1:.3+Math.sin(t*3)*.15}if(this.attract){let t=this.stage.controls,n=this.stage.camera.position.clone().sub(t.target);n.applyAxisAngle(new G(0,1,0),e*.12),this.stage.camera.position.copy(t.target).add(n)}}),this.stage.resizeHandlers.add(()=>{!this.attract&&!this.cameraTweening&&this.focusCamera(this.lastSeat??0,.3)});let n=this.stage.controls;this.stage.camera.position.set(0,16,22),n.update()}on(e,t){this.handlers[e]=t}bindPointer(){let e=this.stage.renderer.domElement,t=null,n=t=>{let n=e.getBoundingClientRect(),r=new W((t.clientX-n.left)/n.width*2-1,-((t.clientY-n.top)/n.height)*2+1);this.raycaster.setFromCamera(r,this.stage.camera);let i=new G,a=this.raycaster.ray.intersectPlane(this.plane,i)?i:null,o=this.raycaster.intersectObjects(this.hitTargets,!1)[0];return{point:a,target:o?o.object.userData.hit:null}};e.addEventListener(`pointerdown`,e=>{t={x:e.clientX,y:e.clientY,t:performance.now(),id:e.pointerId},e.button===2&&this.handlers.rotate?.()}),e.addEventListener(`contextmenu`,e=>e.preventDefault()),e.addEventListener(`pointermove`,e=>{if(e.pointerType!==`mouse`||e.buttons)return;let{point:t,target:r}=n(e);this.handlers.hover?.(t,r)}),e.addEventListener(`pointerleave`,()=>this.handlers.hover?.(null,null)),e.addEventListener(`pointerup`,e=>{if(!t||t.id!==e.pointerId||e.button===2)return;let r=Math.hypot(e.clientX-t.x,e.clientY-t.y),i=performance.now()-t.t;if(t=null,r>10||i>600)return;let{point:a,target:o}=n(e);(a||o)&&this.handlers.tap?.(a,o,e.pointerType)})}clearGame(){for(let e of this.pawns)this.stage.scene.remove(e);for(let e of this.storage)for(let t of e)this.stage.scene.remove(t);for(let e of this.placed)this.stage.scene.remove(e);for(let e of this.goalStrips)this.stage.scene.remove(e);for(let e of this.trayHits)this.stage.scene.remove(e);this.hitTargets=[],this.trayHits=[],this.selected=null,this.trayGlow.visible=!1,this.pawns=[],this.storage=[],this.placed=[],this.goalStrips=[],this.ghost.visible=!1,this.effects.clearAll(),this.effects.setTurnRing(null)}setupGame(e,t){this.clearGame(),this.colors=t.map(e=>xu(e.color).hex);let n=20/e.numPlayers;e.players.forEach((e,r)=>{let i=wu(t[r].color,this.woods),a=du(e.x,e.y);i.position.set(a.x,au,a.z),this.stage.scene.add(i);let o=new Y(new Di(.5,.5,1.45,12),Pu);o.position.y=.72,o.userData.hit={kind:`pawn`,player:r},i.add(o),this.hitTargets.push(o);let s=pu[e.seat],c=new Y(new Ti(5.4,1.4,2.9),Pu);c.position.set(Math.sin(s)*Mu,gu+.6,Math.cos(s)*Mu),c.rotation.y=s,c.userData.hit={kind:`walls`,player:r},this.stage.scene.add(c),this.hitTargets.push(c),this.trayHits.push(c),this.pawns.push(i);let l=new Y(new Ti(lu+.3,.03,.07),new Vi({color:this.colors[r],emissive:new J(this.colors[r]).lerp(new J(16762992),.45),emissiveIntensity:.9,roughness:.4})),u=pu[(e.seat+2)%4],d=lu/2+.27;l.position.set(Math.sin(u)*d,gu+.03,Math.cos(u)*d),l.rotation.y=u,this.stage.scene.add(l),this.goalStrips.push(l),this.storage.push([]);for(let e=0;e<n;e++){let e=Ou(this.woods);this.stage.scene.add(e),this.storage[r].push(e)}}),this.game=e;for(let t of e.walls){let e=this.storage[t.owner].pop(),n=fu(t);e.position.set(n.x,gu,n.z),e.rotation.set(0,n.rotY,0),this.placed.push(e)}e.players.forEach((e,t)=>this.layoutStorage(t,0)),this.attract=!1}storageSlot(e,t){let n=pu[this.game.players[e].seat],r=(t-(20/this.game.numPlayers-1)/2)*Nu;return{x:Math.sin(n)*Mu+Math.cos(n)*r,z:Math.cos(n)*Mu-Math.sin(n)*r,rotY:n+Math.PI/2}}layoutStorage(e,t=.35){this.storage[e].forEach((n,r)=>{let i=this.storageSlot(e,r);if(!t){n.position.set(i.x,gu+.04,i.z),n.rotation.set(0,i.rotY,0);return}let a=n.position.clone();ql({duration:t,update:e=>{n.position.set(a.x+(i.x-a.x)*e,gu+.04,a.z+(i.z-a.z)*e)}})})}setTurn(e){this.game=e;let t=e.current;this.effects.setTurnRing(e.winner===null?this.pawns[t]:null,this.colors[t]),this.pawns.forEach((n,r)=>{n.userData.material.emissiveIntensity=r===t&&e.winner===null?.12:0}),this.goalStrips.forEach((e,n)=>{e.material.emissiveIntensity=n===t?1.6:.25,e.scale.y=n===t?1.6:1});let n=pu[e.players[t].seat];this.trayGlow.position.set(Math.sin(n)*Mu,0,Math.cos(n)*Mu),this.trayGlow.rotation.y=n,this.trayGlow.visible=e.winner===null&&e.players[t].walls>0,this.trayGlowMat.color.set(this.colors[t]).lerp(new J(16762992),.55),this.cameraMode===`auto`&&this.focusCamera(e.players[t].seat)}dropSelection(){this.selToken=(this.selToken??0)+1,this.selected=null}setSelection(e,t,{instant:n=!1}={}){let r=this.selected,i=this.selToken=(this.selToken??0)+1,a=(e,t,r=0)=>{if(!e)return;if(n){e.position.y=t,e.rotation.x=r;return}let a=e.position.y,o=e.rotation.x;ql({duration:.22,easing:Gl.out,update:n=>{i===this.selToken&&(e.position.y=a+(t-a)*n,e.rotation.x=o+(r-o)*n)}})},o=e=>this.storage[e]?.[this.storage[e].length-1];r&&(r.kind!==e||r.player!==t)&&(r.kind===`pawn`?a(this.pawns[r.player],au):a(o(r.player),gu+.04)),this.selected=e?{kind:e,player:t}:null,e===`pawn`?a(this.pawns[t],au+.3):e===`walls`&&a(o(t),gu+.7,.18)}async animateMove(e,t,n){let r=this.pawns[e],i=r.position.clone(),a=du(t.x,t.y),o=n?1.5:.8;await ql({duration:n?.55:.42,easing:Gl.inOut,update:(e,t)=>{r.position.x=i.x+(a.x-i.x)*e,r.position.z=i.z+(a.z-i.z)*e,r.position.y=au+Math.sin(t*Math.PI)*o;let n=1+Math.sin(t*Math.PI)*.08;r.scale.set(1/Math.sqrt(n),n,1/Math.sqrt(n))}}),this.handlers.land?.(`pawn`),this.effects.burst(new G(a.x,au+.05,a.z),{color:16769200,count:18,size:.18}),await ql({duration:.22,easing:Gl.out,update:(e,t)=>{let n=Math.sin(t*Math.PI)*.12;r.scale.set(1+n*.6,1-n,1+n*.6)}}),r.scale.set(1,1,1)}async animateWall(e,t){let n=this.storage[e].pop();this.placed.push(n),this.layoutStorage(e);let r=n.position.clone(),i=n.rotation.y,a=fu(t),o=Fu(i,a.rotY);await ql({duration:.6,easing:Gl.inOut,update:(e,t)=>{n.position.x=r.x+(a.x-r.x)*e,n.position.z=r.z+(a.z-r.z)*e,n.position.y=r.y+(1.4-r.y)*e+Math.sin(t*Math.PI)*2.4*.5,n.rotation.y=i+(o-i)*e,n.rotation.x=Math.sin(t*Math.PI)*.25}});let s=n.position.y;await ql({duration:.42,easing:Gl.outBounce,update:e=>{n.position.y=s+(gu-s)*e,n.rotation.x=0}}),n.position.y=gu,this.handlers.land?.(`wall`);let c=t.o===`h`?new G(1,0,0):new G(0,0,1);for(let e of[-.8,0,.8])this.effects.burst(new G(a.x,au,a.z).addScaledVector(c,e*iu),{color:14268810,count:14,size:.2,speed:1.6});this.shake(.12)}async undoMove(e,t){let n=this.pawns[e],r=n.position.clone(),i=du(t.x,t.y);await ql({duration:.35,update:(e,t)=>{n.position.set(r.x+(i.x-r.x)*e,au+Math.sin(t*Math.PI)*.6,r.z+(i.z-r.z)*e)}}),n.position.y=au}async undoWall(e){let t=this.placed.pop();this.storage[e].push(t);let n=this.storageSlot(e,this.storage[e].length-1),r=t.position.clone(),i=t.rotation.y,a=Fu(i,n.rotY);await ql({duration:.5,update:(e,o)=>{t.position.set(r.x+(n.x-r.x)*e,r.y+(gu+.04-r.y)*e+Math.sin(o*Math.PI)*2,r.z+(n.z-r.z)*e),t.rotation.y=i+(a-i)*e}}),this.layoutStorage(e,0)}async celebrate(e){this.clearHints();let t=this.pawns[e],n=t.position.clone();this.effects.confetti([this.colors[e],`#f5d27a`,`#fff4dc`,`#c9953f`]),this.effects.burst(n.clone().setY(au+.3),{color:16765562,count:60,speed:4,size:.35,up:4,life:1.4});let r=this.stage.lights.warmSpot,i=r.intensity;ql({duration:3,easing:Gl.linear,update:(e,t)=>{r.intensity=i*(1+Math.sin(t*Math.PI)*2.5)}}),await ql({duration:1.6,easing:Gl.inOut,update:(e,r)=>{t.position.y=n.y+Math.sin(r*Math.PI)*1.8,t.rotation.y=e*Math.PI*4}}),t.rotation.y=0,this.stage.controls.autoRotate=!0,this.stage.controls.autoRotateSpeed=.8}shake(e){let t=this.stage.camera;ql({duration:.25,easing:Gl.linear,update:(n,r)=>{let i=e*(1-r);t.position.x+=(Math.random()-.5)*i,t.position.y+=(Math.random()-.5)*i}})}showMoveMarkers(e,t){this.effects.showMarkers(e,this.colors[t])}setHoverCell(e){this.effects.setHoverCell(e)}showGhost(e,t){if(!e){this.ghost.visible=!1;return}let n=fu(e);this.ghost.visible=!0,this.ghost.position.set(n.x,gu+.02,n.z),this.ghost.rotation.set(0,n.rotY,0);let r=this.ghost.material;r.color.set(t?4063098:16730682),r.emissive.set(t?1769306:16718346)}clearHints(){this.effects.clearMarkers(),this.effects.setHoverCell(null),this.showGhost(null)}setCameraMode(e){this.cameraMode=e;let t=this.stage.controls;t.enableRotate=e!==`top`,this.focusCamera(e===`top`?0:this.lastSeat??0)}fitDistance(e){let t=this.stage.camera,n=Et.degToRad(t.fov/2),r=uu*.5,i=r*(Math.cos(e)*.55+.45)/Math.tan(n)+r*.6,a=r/(Math.tan(n)*t.aspect)+r*.4;return Math.min(46,Math.max(i,a)*1.02)}focusCamera(e,t=1.1){this.lastSeat=e,this.stage.controls.autoRotate=!1;let n=this.stage.controls,r=this.stage.camera,i=r.position.clone().sub(n.target),a=new Qa().setFromVector3(i),o=this.cameraMode===`top`,s=o?.001:.78,c=Fu(a.theta,o?0:pu[e]),l=this.fitDistance(s)*(o?.92:.9),u={r:a.radius,phi:a.phi,theta:a.theta};return this.cameraTweening=!0,ql({duration:t,easing:Gl.inOut,update:e=>{let t=new Qa(u.r+(l-u.r)*e,u.phi+(s-u.phi)*e,u.theta+(c-u.theta)*e);r.position.copy(n.target).add(new G().setFromSpherical(t))},complete:()=>{this.cameraTweening=!1}})}startAttract(){this.clearGame(),this.attract=!0,this.stage.controls.autoRotate=!1,this.stage.controls.enableRotate=!0}},Lu=[[0,1],[1,0],[0,-1],[-1,0]],Ru=[{x:4,y:0,goal:{axis:`y`,value:8},seat:0},{x:4,y:8,goal:{axis:`y`,value:0},seat:2}],zu=[{x:4,y:0,goal:{axis:`y`,value:8},seat:0},{x:0,y:4,goal:{axis:`x`,value:8},seat:1},{x:4,y:8,goal:{axis:`y`,value:0},seat:2},{x:8,y:4,goal:{axis:`x`,value:0},seat:3}];function Bu(e=2,t=0){if(e!==2&&e!==4)throw Error(`인원은 2명 또는 4명입니다`);let n=e===2?Ru:zu,r=20/e;return{numPlayers:e,players:n.map(e=>({x:e.x,y:e.y,goal:{...e.goal},seat:e.seat,walls:r})),walls:[],current:t,winner:null,turn:0}}function Vu(e){return{...e,players:e.players.map(e=>({...e,goal:{...e.goal}})),walls:e.walls.map(e=>({...e}))}}var Hu=(e,t,n)=>`${n}${e},${t}`;function Uu(e){let t=new Set;for(let n of e.walls)t.add(Hu(n.x,n.y,n.o));return t}var Wu=(e,t)=>e>=0&&e<9&&t>=0&&t<9;function Gu(e,t,n,r,i){if(t===r){let r=Math.min(n,i);return e.has(Hu(t,r,`h`))||e.has(Hu(t-1,r,`h`))}let a=Math.min(t,r);return e.has(Hu(a,n,`v`))||e.has(Hu(a,n-1,`v`))}function Ku(e){return e.goal.axis===`y`?e.y===e.goal.value:e.x===e.goal.value}function qu(e,t=e.current,n=Uu(e)){let r=e.players[t],i=(n,r)=>e.players.some((e,i)=>i!==t&&e.x===n&&e.y===r),a=[],o=(e,t,n)=>{a.some(n=>n.x===e&&n.y===t)||a.push({x:e,y:t,jump:n})};for(let[e,t]of Lu){let a=r.x+e,s=r.y+t;if(!Wu(a,s)||Gu(n,r.x,r.y,a,s))continue;if(!i(a,s)){o(a,s,!1);continue}let c=a+e,l=s+t;if(Wu(c,l)&&!Gu(n,a,s,c,l)&&!i(c,l)){o(c,l,!0);continue}for(let[r,c]of[[t,e],[-t,-e]]){let e=a+r,t=s+c;Wu(e,t)&&!Gu(n,a,s,e,t)&&!i(e,t)&&o(e,t,!0)}}return a}function Ju(e,t,n=Uu(e)){let{x:r,y:i,o:a}=t;return a!==`h`&&a!==`v`||r<0||r>=8||i<0||i>=8||n.has(Hu(r,i,`h`))||n.has(Hu(r,i,`v`))?!1:a===`h`?!n.has(Hu(r-1,i,`h`))&&!n.has(Hu(r+1,i,`h`)):!n.has(Hu(r,i-1,`v`))&&!n.has(Hu(r,i+1,`v`))}function Yu(e,t,n=Uu(e)){let r=e.players[t];if(Ku(r))return 0;let i=new Int8Array(81).fill(-1),a=[r.x+r.y*9];i[a[0]]=0;for(let e=0;e<a.length;e++){let t=a[e],o=t%9,s=(t-o)/9;for(let[e,c]of Lu){let l=o+e,u=s+c;if(!Wu(l,u))continue;let d=l+u*9;if(!(i[d]!==-1||Gu(n,o,s,l,u))){if(i[d]=i[t]+1,(r.goal.axis===`y`?u:l)===r.goal.value)return i[d];a.push(d)}}}return-1}function Xu(e,t,n=e.current){if(e.winner!==null)return{ok:!1,reason:`게임이 끝났습니다`};if(e.players[n].walls<=0)return{ok:!1,reason:`남은 벽이 없습니다`};let r=Uu(e);if(!Ju(e,t,r))return{ok:!1,reason:`다른 벽과 겹치거나 교차합니다`};r.add(Hu(t.x,t.y,t.o));for(let t=0;t<e.players.length;t++)if(Yu(e,t,r)<0)return{ok:!1,reason:`누군가의 모든 길을 막을 수 없습니다`};return{ok:!0}}function Zu(e,t){if(e.players[t].walls<=0)return!1;for(let n=0;n<8;n++)for(let r=0;r<8;r++)for(let i of[`h`,`v`])if(Xu(e,{x:n,y:r,o:i},t).ok)return!0;return!1}function Qu(e,t){return qu(e,t).length>0||Zu(e,t)}function $u(e,t){if(e.winner!==null)throw Error(`게임이 끝났습니다`);let n=Vu(e),r=n.players[n.current];if(t.type===`move`){if(!qu(e).some(e=>e.x===t.x&&e.y===t.y))throw Error(`갈 수 없는 칸입니다`);r.x=t.x,r.y=t.y,Ku(r)&&(n.winner=n.current)}else if(t.type===`wall`){let i=Xu(e,t);if(!i.ok)throw Error(i.reason);n.walls.push({x:t.x,y:t.y,o:t.o,owner:n.current}),--r.walls}else throw Error(`알 수 없는 행동`);if(n.turn+=1,n.skipped=[],n.winner===null)for(let e=0;e<n.numPlayers&&(n.current=(n.current+1)%n.numPlayers,!Qu(n,n.current));e++)n.skipped.push(n.current);return n}var ed=`kuorido3d.save.v1`,td=class e{constructor(e){this.config=e,this.actions=[],this.states=[Bu(e.numPlayers,e.firstPlayer)]}get game(){return this.states[this.states.length-1]}play(e){let t=$u(this.game,e);return this.actions.push({...e,player:this.game.current}),this.states.push(t),this.save(),t}canUndo(){return!!this.config.allowUndo&&this.actions.length>0&&this.game.winner===null}undo(){if(!this.canUndo())return null;let e=this.actions.pop();return this.states.pop(),this.save(),e}save(){try{this.game.winner===null?localStorage.setItem(ed,JSON.stringify({config:this.config,actions:this.actions})):localStorage.removeItem(ed)}catch{}}static load(){try{let t=localStorage.getItem(ed);if(!t)return null;let{config:n,actions:r}=JSON.parse(t),i=new e(n);for(let e of r)i.play(e);return i}catch{return null}}static hasSave(){try{return!!localStorage.getItem(ed)}catch{return!1}}static clearSave(){try{localStorage.removeItem(ed)}catch{}}},nd=`kuorido3d.setup.v1`,rd={2:[`아래`,`위`],4:[`아래`,`왼쪽`,`위`,`오른쪽`]},id={2:[`ivory`,`ebony`],4:[`ivory`,`crimson`,`ebony`,`teal`]},ad=e=>document.querySelector(e);function od({onStart:e,onResume:t,onRules:n,hasSave:r}){let i={};try{i=JSON.parse(localStorage.getItem(nd)||`{}`)}catch{i={}}let a=i.count===4?4:2,o=i.cameraMode===`top`?`top`:`auto`,s=i.allowUndo===!0,c={2:i.players2??id[2].map((e,t)=>({name:`플레이어 ${t+1}`,color:e})),4:i.players4??id[4].map((e,t)=>({name:`플레이어 ${t+1}`,color:e}))},l=ad(`#player-rows`),u=ad(`#first-player`);function d(){l.innerHTML=``,c[a].forEach((e,t)=>{let n=document.createElement(`div`);n.className=`player-row`,n.style.animationDelay=`${t*.05}s`,n.innerHTML=`
        <div class="seat"><b>P${t+1}</b>${rd[a][t]}</div>
        <input type="text" maxlength="12" value="" />
        <div class="swatches"></div>`;let r=n.querySelector(`input`);r.value=e.name,r.addEventListener(`input`,()=>{e.name=r.value,f()});let i=n.querySelector(`.swatches`);for(let t of bu){let n=document.createElement(`button`);n.className=`swatch`+(e.color===t.id?` active`:``),n.style.background=t.hex,n.title=t.name,n.addEventListener(`click`,()=>{let n=c[a].find(n=>n!==e&&n.color===t.id);n&&(n.color=e.color),e.color=t.id,d()}),i.appendChild(n)}l.appendChild(n)}),f()}function f(){let e=u.value;u.innerHTML=`<option value="random">🎲 무작위</option>`,c[a].forEach((e,t)=>{let n=document.createElement(`option`);n.value=String(t),n.textContent=e.name.trim()||`플레이어 ${t+1}`,u.appendChild(n)}),u.value=[...u.options].some(t=>t.value===e)?e:`random`}return ad(`#player-count`).addEventListener(`click`,e=>{let t=e.target.closest(`button`);t&&(a=Number(t.dataset.n),ad(`#player-count`).querySelectorAll(`button`).forEach(e=>e.classList.toggle(`active`,e===t)),d())}),ad(`#camera-mode`).addEventListener(`click`,e=>{let t=e.target.closest(`button`);t&&(o=t.dataset.mode,ad(`#camera-mode`).querySelectorAll(`button`).forEach(e=>e.classList.toggle(`active`,e===t)))}),ad(`#undo-mode`).addEventListener(`click`,e=>{let t=e.target.closest(`button`);t&&(s=t.dataset.undo===`on`,ad(`#undo-mode`).querySelectorAll(`button`).forEach(e=>e.classList.toggle(`active`,e===t)))}),ad(`#undo-mode`).querySelectorAll(`button`).forEach(e=>e.classList.toggle(`active`,e.dataset.undo===`on`===s)),ad(`#player-count`).querySelectorAll(`button`).forEach(e=>e.classList.toggle(`active`,Number(e.dataset.n)===a)),ad(`#camera-mode`).querySelectorAll(`button`).forEach(e=>e.classList.toggle(`active`,e.dataset.mode===o)),ad(`#btn-start`).addEventListener(`click`,()=>{let t=c[a].map((e,t)=>({name:e.name.trim()||`플레이어 ${t+1}`,color:e.color})),n=u.value===`random`?Math.floor(Math.random()*a):Number(u.value);try{localStorage.setItem(nd,JSON.stringify({count:a,cameraMode:o,allowUndo:s,players2:c[2],players4:c[4]}))}catch{}e({numPlayers:a,firstPlayer:n,players:t,cameraMode:o,allowUndo:s})}),ad(`#btn-resume`).addEventListener(`click`,t),ad(`#btn-rules-open`).addEventListener(`click`,n),d(),{show(){ad(`#btn-resume`).hidden=!r(),ad(`#setup`).classList.add(`show`)},hide(){ad(`#setup`).classList.remove(`show`)}}}var sd=e=>document.querySelector(e),cd=class{constructor(){this.bar=sd(`#players-bar`),this.banner=sd(`#turn-banner`),this.toastEl=sd(`#toast`),this.actionBar=sd(`#action-bar`)}show(){sd(`#hud`).hidden=!1}hide(){sd(`#hud`).hidden=!0}update(e,t){let n=20/e.numPlayers;this.bar.innerHTML=``,e.players.forEach((r,i)=>{let a=t.players[i],o=document.createElement(`div`);o.className=`pcard`+(i===e.current&&e.winner===null?` current`:``),o.style.setProperty(`--pc`,xu(a.color).hex);let s=Array.from({length:n},(e,t)=>`<i class="${t<r.walls?``:`used`}"></i>`).join(``),c=Yu(e,i);o.innerHTML=`
        <div class="dot"></div>
        <div class="info">
          <div class="name"></div>
          <div class="meta"><span class="pips" title="남은 벽 ${r.walls}개">${s}</span><span>🏁 ${c}칸</span></div>
        </div>`,o.querySelector(`.name`).textContent=a.name,this.bar.appendChild(o)})}setMode(e,t){sd(`#mode-seg`).querySelectorAll(`button`).forEach(t=>t.classList.toggle(`active`,t.dataset.mode===e)),sd(`#mode-seg`).querySelector(`[data-mode="wall"]`).disabled=t<=0,sd(`#walls-left`).textContent=t;let n=sd(`#action-hint`);n.innerHTML=e===`move`?`<b>♟ 말 이동</b> 빛나는 칸을 누르세요`:e===`wall`?`<b>▮ 벽 놓기</b> 칸 사이 홈을 누르세요`:t>0?`버튼 또는 <b>내 말</b> · <b>내 벽 보관대</b>를 눌러 선택하세요`:`버튼 또는 <b>내 말</b>을 눌러 이동하세요 (남은 벽 없음)`,sd(`#btn-rotate`).hidden=e!==`wall`}setUndo(e,t){sd(`#btn-undo`).hidden=!e,sd(`#btn-undo`).disabled=!t}setOrientation(e){sd(`#btn-rotate`).classList.toggle(`vertical`,e===`v`)}setConfirm(e){sd(`#btn-confirm`).hidden=!e}setBusy(e){this.actionBar.classList.toggle(`disabled`,e)}turnBanner(e,t){let n=this.banner;n.textContent=e,n.style.setProperty(`--pc`,t),n.classList.remove(`show`),n.offsetWidth,n.classList.add(`show`)}toast(e,t=`error`){let n=this.toastEl;n.textContent=e,n.className=t===`info`?`info show`:`show`,clearTimeout(this.toastTimer),this.toastTimer=setTimeout(()=>n.classList.remove(`show`),1800)}},ld=null,ud=!1;try{ud=localStorage.getItem(`kuorido3d.muted`)===`1`}catch{}function dd(){return ld||=new(window.AudioContext||window.webkitAudioContext),ld.state===`suspended`&&ld.resume(),ld}var fd=()=>ud;function pd(e){ud=e;try{localStorage.setItem(`kuorido3d.muted`,e?`1`:`0`)}catch{}}function md(e,t){let n=e.createBuffer(1,e.sampleRate*t,e.sampleRate),r=n.getChannelData(0);for(let e=0;e<r.length;e++)r[e]=(Math.random()*2-1)*(1-e/r.length)**3;return n}function hd({freq:e=420,q:t=6,gain:n=.6,body:r=160,dur:i=.18}={}){if(ud)return;let a=dd(),o=a.currentTime,s=a.createBufferSource();s.buffer=md(a,i);let c=a.createBiquadFilter();c.type=`bandpass`,c.frequency.value=e,c.Q.value=t;let l=a.createGain();l.gain.setValueAtTime(n,o),l.gain.exponentialRampToValueAtTime(.001,o+i),s.connect(c).connect(l).connect(a.destination),s.start(o);let u=a.createOscillator();u.type=`sine`,u.frequency.setValueAtTime(r,o),u.frequency.exponentialRampToValueAtTime(r*.55,o+.12);let d=a.createGain();d.gain.setValueAtTime(n*.7,o),d.gain.exponentialRampToValueAtTime(.001,o+.14),u.connect(d).connect(a.destination),u.start(o),u.stop(o+.16)}function gd(e,t,n,{type:r=`triangle`,gain:i=.18}={}){let a=dd(),o=a.currentTime+t,s=a.createOscillator();s.type=r,s.frequency.value=e;let c=a.createGain();c.gain.setValueAtTime(1e-4,o),c.gain.exponentialRampToValueAtTime(i,o+.02),c.gain.exponentialRampToValueAtTime(1e-4,o+n),s.connect(c).connect(a.destination),s.start(o),s.stop(o+n+.05)}var _d={unlock:()=>dd(),pawn:()=>hd({freq:900,q:3,gain:.45,body:220,dur:.12}),wall:()=>hd({freq:520,q:4,gain:.8,body:130,dur:.22}),click:()=>hd({freq:1800,q:8,gain:.18,body:600,dur:.05}),error:()=>{ud||(gd(220,0,.12,{type:`square`,gain:.06}),gd(165,.1,.18,{type:`square`,gain:.06}))},turn:()=>{ud||(gd(660,0,.18,{gain:.07}),gd(990,.08,.25,{gain:.05}))},win:()=>{ud||([523.25,659.25,783.99,1046.5,783.99,1046.5,1318.5].forEach((e,t)=>gd(e,t*.12,.5,{gain:.14})),gd(261.63,0,1.4,{type:`sine`,gain:.12}))}},Q=e=>document.querySelector(e),vd=(e,t)=>Q(e).classList.toggle(`show`,t);await new Promise(e=>setTimeout(e,50));var yd=new Iu(Q(`#stage`)),$=new cd,bd=null,xd=null,Sd=`h`,Cd=null,wd=null,Td=!1,Ed=()=>bd.game,Dd=e=>bd.config.players[e].name,Od=e=>xu(bd.config.players[e].color).hex,kd=()=>bd&&!Td&&Ed().winner===null;function Ad(e){bd=e,Td=!1,$.setBusy(!1),vd(`#win`,!1),qd.hide(),$.show(),yd.setupGame(Ed(),e.config.players),yd.cameraMode=e.config.cameraMode,yd.stage.controls.enableRotate=e.config.cameraMode!==`top`,yd.focusCamera(Ed().players[Ed().current].seat,1.4),Sd=`h`,jd(!0)}function jd(e=!1){let t=Ed();yd.setTurn(t),$.update(t,bd.config),$.setOrientation(Sd),Ld(null,{silent:!0,instant:!0}),Pd(),$.turnBanner(`${Dd(t.current)} 차례`,Od(t.current)),e||_d.turn(),t.skipped?.length&&$.toast(`${t.skipped.map(Dd).join(`, `)}: 움직일 수 없어 차례를 건너뜁니다`,`info`)}function Md(){if(yd.clearHints(),kd()){if(xd===`move`)yd.showMoveMarkers(qu(Ed()),Ed().current);else if(xd===`wall`){let e=Cd??wd;e&&yd.showGhost(e,Xu(Ed(),e).ok)}}}async function Nd(e){if(Td)return;let t=Ed(),n;try{n=bd.play(e)}catch(e){$.toast(e.message),_d.error();return}if(Td=!0,Cd=null,wd=null,$.setBusy(!0),$.setConfirm(!1),yd.clearHints(),yd.dropSelection(),yd.stage.renderer.domElement.style.cursor=``,e.type===`move`){let n=t.players[t.current],r=Math.abs(e.x-n.x)+Math.abs(e.y-n.y)>1;await yd.animateMove(t.current,e,r)}else await yd.animateWall(t.current,e);Td=!1,$.setBusy(!1),n.winner===null?jd():Id(n.winner)}function Pd(){let e=!!bd?.config.allowUndo;$.setUndo(e,e&&bd.canUndo()),Q(`#btn-undo-toggle`).textContent=`무르기: ${e?`켬`:`끔 (공식 규칙)`}`}async function Fd(){if(Td||!bd?.canUndo())return;Ld(null,{silent:!0,instant:!0});let e=bd.undo();Td=!0,$.setBusy(!0),yd.clearHints(),e.type===`move`?await yd.undoMove(e.player,Ed().players[e.player]):await yd.undoWall(e.player),Td=!1,$.setBusy(!1),jd(!0),$.toast(`한 수 물렀습니다`,`info`)}async function Id(e){let t=Ed();$.update(t,bd.config),$.setMode(null,0),Pd(),$.setBusy(!0),yd.setTurn(t),_d.win(),Q(`#win-title`).textContent=`${Dd(e)} 승리!`,Q(`#win-title`).style.setProperty(`--pc`,Od(e)),Q(`#win-sub`).textContent=`총 ${t.turn}수 · 남은 벽 ${t.players[e].walls}개`,await yd.celebrate(e),vd(`#win`,!0)}function Ld(e,{silent:t=!1,instant:n=!1}={}){if(!bd||Ed().winner!==null)return;let r=Ed().players[Ed().current];if(e===`wall`&&r.walls<=0){$.toast(`남은 벽이 없습니다`),_d.error();return}xd=e,Cd=null,wd=null,yd.setSelection(e===`move`?`pawn`:e===`wall`?`walls`:null,Ed().current,{instant:n}),$.setMode(xd,r.walls),$.setConfirm(!1),t||_d.click(),Md()}function Rd(){bd&&xd===`wall`&&(Sd=Sd===`h`?`v`:`h`,$.setOrientation(Sd),Cd&&={...Cd,o:Sd},wd&&={...wd,o:Sd},$.setConfirm(!!Cd&&Xu(Ed(),Cd).ok),_d.click(),Md())}function zd(e){if(e.player!==Ed().current){$.toast(`지금은 ${Dd(Ed().current)} 차례입니다`,`info`),_d.error();return}e.kind===`pawn`?Ld(xd===`move`?null:`move`):Ld(xd===`wall`?null:`wall`)}var Bd=e=>{if(!e)return null;let t=mu(e.x,e.z);return qu(Ed()).find(e=>e.x===t.x&&e.y===t.y)??null};yd.on(`hover`,(e,t)=>{if(!kd())return;let n=Ed().current,r=t&&t.player===n,i=!!r;if(xd===`move`)yd.setHoverCell(e?mu(e.x,e.z):null),Bd(e)&&(i=!0);else if(xd===`wall`&&!Cd){let t=!r&&e?hu(e.x,e.z):null;wd=t&&t.inside?{x:t.x,y:t.y,o:Sd}:null,wd&&(i=!0),Md()}yd.stage.renderer.domElement.style.cursor=i?`pointer`:``}),yd.on(`tap`,(e,t,n)=>{if(kd()){if(_d.unlock(),xd===`move`){let n=Bd(e);if(n&&!(t&&t.kind===`walls`)){Nd({type:`move`,x:n.x,y:n.y});return}}if(t){zd(t);return}if(xd===`wall`&&e){let t=hu(e.x,e.z);if(!t.inside){Cd=null,$.setConfirm(!1),Md();return}let r={x:t.x,y:t.y,o:Sd},i=Xu(Ed(),r);if(n!==`mouse`){if(Cd&&Cd.x===r.x&&Cd.y===r.y&&Cd.o===r.o&&i.ok){Nd({type:`wall`,...r});return}Cd=r,$.setConfirm(i.ok),i.ok?_d.click():($.toast(i.reason),_d.error()),Md()}else i.ok?Nd({type:`wall`,...r}):($.toast(i.reason),_d.error());return}xd===null?$.toast(`내 말을 누르면 이동, 내 벽 보관대를 누르면 벽 놓기`,`info`):xd===`move`&&Ld(null)}}),yd.on(`rotate`,()=>Rd()),yd.on(`land`,e=>e===`wall`?_d.wall():_d.pawn()),Q(`#mode-seg`).addEventListener(`click`,e=>{let t=e.target.closest(`button`);t&&kd()&&Ld(t.dataset.mode===xd?null:t.dataset.mode)}),Q(`#btn-undo`).addEventListener(`click`,Fd),Q(`#btn-undo-toggle`).addEventListener(`click`,()=>{bd&&(bd.config.allowUndo=!bd.config.allowUndo,bd.save(),Pd(),$.toast(bd.config.allowUndo?`무르기를 켰습니다`:`무르기를 껐습니다 (공식 규칙)`,`info`))}),Q(`#btn-rotate`).addEventListener(`click`,Rd),Q(`#btn-confirm`).addEventListener(`click`,()=>{Cd&&!Td&&Nd({type:`wall`,...Cd})}),document.addEventListener(`click`,e=>e.target.closest?.(`button`)?.blur()),window.addEventListener(`keydown`,e=>{bd&&e.target.tagName!==`INPUT`&&(Q(`#setup`).classList.contains(`show`)||(e.key===`r`||e.key===`R`?Rd():e.code===`Space`||e.key===` `?(e.preventDefault(),kd()&&Ld(xd===`move`?`wall`:`move`)):(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()===`z`?(e.preventDefault(),Fd()):e.key===`Escape`?xd&&kd()?Ld(null):Hd():e.key===`Enter`&&Cd&&!Td&&Nd({type:`wall`,...Cd})))});var Vd=()=>Q(`#btn-sound`).textContent=fd()?`🔇`:`🔊`;Vd(),Q(`#btn-sound`).addEventListener(`click`,()=>{pd(!fd()),Vd(),_d.click()}),Q(`#btn-camera`).addEventListener(`click`,()=>{if(!bd)return;let e=yd.cameraMode===`auto`?`top`:`auto`;bd.config.cameraMode=e,bd.save(),yd.setCameraMode(e),e===`auto`&&yd.focusCamera(Ed().players[Ed().current].seat),$.toast(e===`top`?`카메라: 위에서 고정`:`카메라: 차례마다 회전`,`info`)}),Q(`#btn-fullscreen`).addEventListener(`click`,()=>{let e=document;e.fullscreenElement?e.exitFullscreen?.():e.documentElement.requestFullscreen?.().catch(()=>{})});function Hd(e){vd(`#menu`,e??!Q(`#menu`).classList.contains(`show`))}Q(`#btn-menu`).addEventListener(`click`,()=>Hd(!0)),Q(`#menu`).addEventListener(`click`,e=>{e.target.id===`menu`&&Hd(!1)}),Q(`#btn-continue`).addEventListener(`click`,()=>Hd(!1)),Q(`#btn-restart`).addEventListener(`click`,()=>{Hd(!1),Ad(new td({...bd.config}))}),Q(`#btn-new`).addEventListener(`click`,()=>{Hd(!1),Kd()}),Q(`#btn-rules`).addEventListener(`click`,()=>{Hd(!1),vd(`#rules`,!0)});var Ud=`kuorido3d.quality`,Wd=!0;try{Wd=localStorage.getItem(Ud)!==`low`}catch{}var Gd=()=>{yd.stage.setQuality(Wd),Q(`#btn-quality`).textContent=`그래픽 품질: ${Wd?`높음`:`낮음 (태블릿 절전)`}`};Gd(),Q(`#btn-quality`).addEventListener(`click`,()=>{Wd=!Wd;try{localStorage.setItem(Ud,Wd?`high`:`low`)}catch{}Gd()}),Q(`#btn-rules-close`).addEventListener(`click`,()=>vd(`#rules`,!1)),Q(`#rules`).addEventListener(`click`,e=>{e.target.id===`rules`&&vd(`#rules`,!1)}),Q(`#btn-win-again`).addEventListener(`click`,()=>{Ad(new td({...bd.config,firstPlayer:(bd.config.firstPlayer+1)%bd.config.numPlayers}))}),Q(`#btn-win-new`).addEventListener(`click`,Kd),Q(`#btn-win-view`).addEventListener(`click`,()=>vd(`#win`,!1));function Kd(){bd=null,vd(`#win`,!1),$.hide(),yd.startAttract(),qd.show()}var qd=od({onStart:e=>{_d.unlock(),td.clearSave(),Ad(new td(e))},onResume:()=>{_d.unlock();let e=td.load();e?Ad(e):$.toast(`저장된 게임을 불러올 수 없습니다`)},onRules:()=>vd(`#rules`,!0),hasSave:()=>td.hasSave()});vd(`#loading`,!1),Kd();